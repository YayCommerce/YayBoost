    ...
    public function get_all(): array {
        return [
            'before_checkout_form'          => [
                ...
                'priority' => 10,
                'label'    => __( 'Before checkout form', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'before_checkout_billing_form'  => [
                'hook'     => 'woocommerce_before_checkout_billing_form',
                'priority' => 10,
                'label'    => __( 'Before billing form', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_checkout_billing_form'   => [
                'hook'     => 'woocommerce_after_checkout_billing_form',
                'priority' => 10,
                'label'    => __( 'After billing form', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'before_checkout_shipping_form' => [
                'hook'     => 'woocommerce_before_checkout_shipping_form',
                'priority' => 10,
                'label'    => __( 'Before shipping form', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_checkout_shipping_form'  => [
                'hook'     => 'woocommerce_after_checkout_shipping_form',
                'priority' => 10,
                'label'    => __( 'After shipping form', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'before_order_notes'            => [
                'hook'     => 'woocommerce_before_order_notes',
                'priority' => 10,
                'label'    => __( 'Before order notes', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_order_notes'             => [
                'hook'     => 'woocommerce_after_order_notes',
                'priority' => 10,
                'label'    => __( 'After order notes', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'review_order_before_payment'   => [
                'hook'     => 'woocommerce_review_order_before_payment',
                'priority' => 10,
                'label'    => __( 'Before payment section', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'review_order_after_payment'    => [
                'hook'     => 'woocommerce_review_order_after_payment',
                'priority' => 10,
                'label'    => __( 'After payment section', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_checkout_form'           => [
                'hook'     => 'woocommerce_after_checkout_form',
                'priority' => 10,
                'label'    => __( 'After checkout form', 'yayboost-sales-booster-for-woocommerce' ),
            ],
        ];
    }
}
