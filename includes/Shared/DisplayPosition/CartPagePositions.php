    ...
    public function get_all(): array {
        return [
            'before_cart'         => [
                ...
                'priority' => 10,
                'label'    => __( 'Before cart', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'before_cart_table'   => [
                'hook'     => 'woocommerce_before_cart_table',
                'priority' => 10,
                'label'    => __( 'Before cart table', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_cart_table'    => [
                'hook'     => 'woocommerce_after_cart_table',
                'priority' => 10,
                'label'    => __( 'After cart table', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'before_cart_totals'  => [
                'hook'     => 'woocommerce_before_cart_totals',
                'priority' => 10,
                'label'    => __( 'Before cart totals', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_cart_totals'   => [
                'hook'     => 'woocommerce_after_cart_totals',
                'priority' => 10,
                'label'    => __( 'After cart totals', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'proceed_to_checkout' => [
                'hook'     => 'woocommerce_proceed_to_checkout',
                'priority' => 15,
                'label'    => __( 'Near proceed to checkout', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_cart'          => [
                'hook'     => 'woocommerce_after_cart',
                'priority' => 10,
                'label'    => __( 'After cart', 'yayboost-sales-booster-for-woocommerce' ),
            ],
        ];
    }
}
