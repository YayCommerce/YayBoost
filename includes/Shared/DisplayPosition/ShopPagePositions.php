    ...
    public function get_all(): array {
        return [
            'before_shop_loop_item'       => [
                ...
                'priority' => 10,
                'label'    => __( 'Before product item', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'before_shop_loop_item_title' => [
                'hook'     => 'woocommerce_before_shop_loop_item_title',
                'priority' => 10,
                'label'    => __( 'Before product title', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_shop_loop_item_title'  => [
                'hook'     => 'woocommerce_shop_loop_item_title',
                'priority' => 15,
                'label'    => __( 'After product title', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_shop_loop_item'        => [
                'hook'     => 'woocommerce_after_shop_loop_item',
                'priority' => 10,
                'label'    => __( 'After product item', 'yayboost-sales-booster-for-woocommerce' ),
            ],
            'after_shop_loop_item_late'   => [
                'hook'     => 'woocommerce_after_shop_loop_item',
                'priority' => 15,
                'label'    => __( 'After product item (late)', 'yayboost-sales-booster-for-woocommerce' ),
            ],
        ];
    }
}
