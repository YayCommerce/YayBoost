...
export const PRODUCT_PAGE_POSITIONS: PositionOption[] = [
  { value: 'below_product_title', label: __('Below product title', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'below_price', label: __('Below price', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'below_short_description', label: __('Below short description', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'above_add_to_cart_button', label: __('Above Add to Cart button', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'below_add_to_cart_button', label: __('Below Add to Cart button', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'below_meta', label: __('Below product meta', 'yayboost-sales-booster-for-woocommerce') },
];

/** Shop/category page positions */
export const SHOP_PAGE_POSITIONS: PositionOption[] = [
  { value: 'before_shop_loop_item', label: __('Before product item', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'before_shop_loop_item_title', label: __('Before product title', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_shop_loop_item_title', label: __('After product title', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_shop_loop_item', label: __('After product item', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_shop_loop_item_late', label: __('After product item (late)', 'yayboost-sales-booster-for-woocommerce') },
];

/** Cart page positions */
export const CART_PAGE_POSITIONS: PositionOption[] = [
  { value: 'before_cart', label: __('Before cart', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'before_cart_table', label: __('Before cart table', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_cart_table', label: __('After cart table', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'before_cart_totals', label: __('Before cart totals', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_cart_totals', label: __('After cart totals', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'proceed_to_checkout', label: __('Near proceed to checkout', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_cart', label: __('After cart', 'yayboost-sales-booster-for-woocommerce') },
];

/** Checkout page positions */
export const CHECKOUT_PAGE_POSITIONS: PositionOption[] = [
  { value: 'before_checkout_form', label: __('Before checkout form', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'before_checkout_billing_form', label: __('Before billing form', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_checkout_billing_form', label: __('After billing form', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'before_checkout_shipping_form', label: __('Before shipping form', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_checkout_shipping_form', label: __('After shipping form', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'before_order_notes', label: __('Before order notes', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_order_notes', label: __('After order notes', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'review_order_before_payment', label: __('Before payment section', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'review_order_after_payment', label: __('After payment section', 'yayboost-sales-booster-for-woocommerce') },
  { value: 'after_checkout_form', label: __('After checkout form', 'yayboost-sales-booster-for-woocommerce') },
];
...
export const PAGE_TYPE_LABELS: Record<PageType, string> = {
  [PAGE_PRODUCT]: __('Product Page', 'yayboost-sales-booster-for-woocommerce'),
  [PAGE_SHOP]: __('Shop / Category Pages', 'yayboost-sales-booster-for-woocommerce'),
  [PAGE_CART]: __('Cart Page', 'yayboost-sales-booster-for-woocommerce'),
  [PAGE_CHECKOUT]: __('Checkout Page', 'yayboost-sales-booster-for-woocommerce'),
};
